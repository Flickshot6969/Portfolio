...
export default function Skills() {
  ...
  return (
    <section id="skills" className="section-padding relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-0 w-96 h-96 bg-primary-500/10 rounded-full blur-3xl -translate-y-1/2 -translate-x-1/2" />
      <div className="absolute top-1/2 right-0 w-96 h-96 bg-accent-500/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
        ...
        >
          {skillCategories.map((category) => (
            <motion.button
              ...
              className={`relative flex items-center gap-3 px-6 py-4 rounded-2xl transition-all duration-500 ${
            ...
            >
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-dark-400">{category.subtitle}</p>
              </div>
              {activeCategory === category.id && (
                <motion.div
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div className={`p-2 rounded-xl bg-gradient-to-r ${activeSkills.color} opacity-80 group-hover:opacity-100 transition-opacity`}>
          ...
          <div className="relative z-10">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="text-center p-6">
                ...
                <h4 className="font-semibold text-white mb-2">Leadership Ability</h4>
                <p className="text-sm text-dark-400">
              ...
              <div className="text-center p-6">
                ...
                <h4 className="font-semibold text-white mb-2">Business Acumen</h4>
                <p className="text-sm text-dark-400">
